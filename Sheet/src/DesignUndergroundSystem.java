...
public class DesignUndergroundSystem {
    /**
     * InnerDesignUndergroundSystem
     */
    public class InnerDesignUndergroundSystem {

        int id, time;
        String stationName;

        InnerDesignUndergroundSystem(int id, String stationName, int time) {
            this.time = time;
            this.id = id;
    ...
    HashMap<Integer, InnerDesignUndergroundSystem> arrivals;
    ...
    public void checkIn(int id, String stationName, int t) {
        arrivals.put(id, new InnerDesignUndergroundSystem(id, stationName, t));
    }

    public void checkOut(int id, String stationName, int t) {
        InnerDesignUndergroundSystem obj = arrivals.get(id);
        String key = obj.stationName + "_" + stationName;
